...
@st.cache_data
def load_data():
    return pd.read_csv(r'C:\Users\sanju\Downloads\cmse_mid_project\nyc_taxi_trip_duration.csv', encoding='utf-8')
...
def goal_and_overview():
    ...
    img = Image.open(r"C:\Users\sanju\Downloads\cmse_mid_project\just_image_nyc.png")
...
def eda_page():
    ...
    osrm_data = pd.read_csv(r'C:\Users\sanju\Downloads\cmse_mid_project\osrm_data_train.zip', usecols=cols)
    osrm_data.head()
    ...
    holiday_data = pd.read_csv(r'C:\Users\sanju\Downloads\cmse_mid_project\holiday_data.csv', sep=';')
    ...
    weather_data = pd.read_csv(r'C:\Users\sanju\Downloads\cmse_mid_project\weather_data.zip', usecols=columns)
    weather_data.head()
